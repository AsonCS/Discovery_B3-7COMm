...
export const metadata: Metadata = {
  title: "Colheita Digital - Tokenize-se: O Valor Além da Moeda",
  description:
  ...
  keywords: "tokenização, blockchain, pequenos negócios, economia local, stablecoins, fidelidade digital",
  authors: [{ name: "Colheita Digital Team" }],
  openGraph: {
    title: "Colheita Digital - Tokenize-se: O Valor Além da Moeda",
    description: "Democratize o acesso a capital e fortaleça a economia local com tokenização de ativos produtivos.",
    type: "website",
    locale: "pt_BR",
  },
  twitter: {
