...
export const metadata: Metadata = {
  metadataBase: new URL("https://colheita-digital.vercel.app"),
  title: {
    default: "Colheita Digital - Tokenize-se: O Valor Além da Moeda",
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={`${inter.variable} ${poppins.variable}`}>
      <head>
        <link rel="canonical" href="https://colheita-digital.vercel.app" />
      </head>
